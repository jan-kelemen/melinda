...
namespace
{
    ...
    // server side.
    melinda::mblcxx::result<std::string> generate_identity()
    {
        ...
        {
            return melinda::mblcxx::res<std::string>::error(
        ...
        return melinda::mblcxx::res<std::string>::ok(rv);
    }
} // namespace

melinda::mblcxx::result<zmq::socket_t> melinda::mdbnet::client::connect(
